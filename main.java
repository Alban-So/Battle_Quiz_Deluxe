...
class main extends Program {
 ...
 //#region déclaration des constantes du jeux
    ...
    void partieEnCours(CSVFile fichierSauvegarde, String typeDePartie){
        ...
        //-------Tampon de mémoire pour intervertir à chaque fois les joueurs------//
        ...
        if(equals(typeDePartie,"1vs1")){                    //*GESTION DU MODE 1V1*//
            ...
            Joueur j1=formulaireCréationJoueur(1);          //Création des Joueurs avec leur classe
            viderPlateau();
            ...
            while(!finDePartie){// Lancement du gameplay, tourne tant que finDePartie est sur false.
                ...
                while(!tourFini){
                    if(joueurQuiCommence==1){
                        ...
                        plateauJoueurQuiJoue=plateauJoueur2;
                    }
                    ...
                    if(numTour==0 || numTour==1){
                        ...
                        switch(choixJoueurInteractionMain){
                            case 1:
                                plateauJoueurQuiJoue[0]=mainJoueurQuiJoue[0];//on considere que l'indice 0 du plateau de chaque joueur est la carte actif
                                //mainJoueurQuiJoue[0]=vide
            
                            case 2:
                                plateauJoueurQuiJoue[1]=mainJoueurQuiJoue[1]; // carte banc
                                //mainJoueurQuiJoue[1]=vide
                            
                            case 3:
                                plateauJoueurQuiJoue[2]=mainJoueurQuiJoue[2];// carte banc
    ...
    void interactionMainJoueur(int choix, Carte[] mainJoueurQuiJoue,int[] deckJoueurQuiJoue, int[] plateauJoueur1){
    }



    int choixJoueurEnPartie(){
        int choixJoueurEnPartie;
        do{
            choixJoueurEnPartie=readInt();
        }while(choixJoueurEnPartie<1 || choixJoueurEnPartie >6);
        return choixJoueurEnPartie;
    ...
    int choixJoueurInteractionMain(){
        ...
        }while(choixJoueurInteractionMain<1 || choixJoueurInteractionMain >7);
